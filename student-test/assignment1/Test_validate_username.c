...
/*    TEST_ASSERT_TRUE_MESSAGE(false,"AESD students, please fix me!");*/
    /* 1) Call the my_username() function in autotest-validate.c
     *    to get your hard coded username. */
    /* const char *my_username() */
    //char username1[20];
    //&username1 = my_username();
    printf("1) %s\n", my_username());

    /* 2) Obtain the value returned from function 
     *    malloc_username_from_conf_file() in username-from-conf-file.h within
          the assignment autotest submodule at 
	  assignment-autotest/test/assignment1/ */
    /* static inline char *malloc_username_from_conf_file() */
    //char username2[20];
    //&username2 = malloc_username_from_conf_file();
    ...
    //TEST_ASSERT_EQUAL_STRING(username1, username2);
